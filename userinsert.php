...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p" crossorigin="anonymous"></script>
    ...
    <br>
    <center><h1>REGISTRO USUARIOS</h1></center> <BR>
        ...
        <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
            ...
            <div class="accordion-body">
                <label class="form-label"><b> E-mail:</b><br>
                    <input type="email" name="email" class="form-control" placeholder="Ingrese el tipo de contrato">
                </label>
...
{
    $condc=$nav->queryUserId($_POST['idcond']);  
    if(sizeof($condc)==0)
    {
        $inf[]=$_POST;
        $con=$user->insertuser($inf); 
    }else
    {
        echo "<script type='text/javascript'>
